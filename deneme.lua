...
local function RGBToggleBar(bar)
    task.spawn(function()
        ...
        while bar and bar.Parent do
            ...
            if pos > bar.Parent.AbsoluteSize.X - 50 or pos < 0 then
                dir = -dir
            end
...
local function loadHub()
    ...
    local function createSnow()
        ...
        snow.ZIndex = 0
        snow.Position = UDim2.new(0, math.random(0,800), 0, -10)

        snow:TweenPosition(
            UDim2.new(0, math.random(0,800), 0, 530),
            "Out", "Linear",
            math.random(5,8),
            true,
            function()
